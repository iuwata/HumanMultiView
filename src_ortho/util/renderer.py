...
def simple_renderer(rn,
    ...
    rn.vc = LambertianPointLight(
        ...
        v=rn.v,
        num_verts=len(rn.v),
        light_pos=_rotateY(np.array([-20000, -10000, -10000]), yrot),
        vc=albedo,
    ...
    rn.vc += LambertianPointLight(
        ...
        v=rn.v,
        num_verts=len(rn.v),
        light_pos=_rotateY(np.array([80000, 1000, 30000]), yrot),
        vc=albedo,
        light_color=np.array([1, 1, 1]))
    ...
    rn.vc += LambertianPointLight(
        ...
        v=rn.v,
        num_verts=len(rn.v),
        light_pos=_rotateY(np.array([-50000, 50000, 100000]), yrot),
        vc=albedo,
